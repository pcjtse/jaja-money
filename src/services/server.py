...
from src.core.rate_limiter import TokenBucketRateLimiter  # noqa: E402
...
async def portfolio(
    ...
    try:
        from src.analysis.portfolio_analysis import analyze_portfolio
...
async def chat(
    ...
    try:
        from src.analysis.factors import compute_factors
        from src.analysis.guardrails import compute_risk
        from src.analysis.analyzer import stream_chat_response, build_chat_system_prompt
...
async def forward_test_trade(
    ...
    """
    try:
        from src.analysis.forward_test import add_position, snapshot_portfolio
