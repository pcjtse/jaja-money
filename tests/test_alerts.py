...
def test_add_and_get_alert():
    from src.ui.alerts import add_alert, get_alerts
...
def test_price_above_trigger():
    from src.ui.alerts import add_alert, check_alerts, get_alerts
...
def test_price_above_no_trigger():
    from src.ui.alerts import add_alert, check_alerts
...
def test_delete_alert():
    from src.ui.alerts import add_alert, delete_alert, get_alerts
...
def test_reset_alert():
    from src.ui.alerts import add_alert, check_alerts, reset_alert, get_alerts
